...
implementation side effects or under-specified parser behaviour leads to a
...
research community, this has been generalised into treating a program
...
\XXX[how does Nail relate to Hammer, in terms of what's new, what it
solves, etc?]
