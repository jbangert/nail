...
this with an alternative form of the structure combinator,
...
There are many ways conceptual streams could be encoded in a data format --
A tool like Nail needs to support all of them. This makes data description languages like
PADS~\cite{Fisher:2005:PDL:1064978.1065046} contain not just a kitchen sink, but a kitchen store
full of features -- and a language that can handle all possible format oddities will be a general
purpose language.  Nail instead of allows you to plug in your own code as \emph{transformations},
with a small, but powerful camping kitchen included that will handle most formats.
...
Typically, grammars start out with a single stream, which may then
...
transforms.
 ...
 To make your life easier and your code safer, Nails provides implementations of
