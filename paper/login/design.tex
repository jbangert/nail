...
DNS. A more complete reference can be found in Figure~\ref{fig:syntax}, with detailed rationale in~\cite{bangert:nail-osdi14}.
...
explain how to handle count fields, and our full paper~\cite{bangert:nail-osdi14} describes how to handle various array
