...
\XXX[do we have any evidence to cite for this claim?]
...
construct outputs, which is error-prone.
\XXX[do we have any evidence to cite for this claim?]
...
causes inconsistencies~\cite{cve-python-zip-maybe}.  Furthermore, security
...
value of another~\cite{cve-some-example}.
...
data representations.  Performance results show that the Nail-based DNS
server outperforms the widely used BIND DNS server, demonstrating that
Nail-based parsers and generators can achieve good performance.
