...
\XXX[Motivate Stream transforms better]
...
length, offset and checksum fields. \XXX[Stream transforms allow the programmer to write a function
that produces one or more virtual streams from one or more virtual streams and the values of
dependent fields.]
