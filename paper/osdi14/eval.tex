...
The \cc{zip\_file} grammarfirst splits the entire file stream into two
streams based on the \cc{zip\_end\_of\_directory} transform in line 2
(whose two C function signatures are shown in
Figure~\ref{fig:zip-eod-xform}). \cc{zip\_end\_of\_directory_parse}
...
The \cc{file} rule starting at line 41, describing a ZIP file entry takes dependent field
...
Nail also protects against parsing ambiguity vulnerabilities like the four others we studied. First,
