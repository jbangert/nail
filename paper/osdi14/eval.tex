...
these formats would be very hard to parse with other parser generators. The following table lists
our example grammars, along with any features that make those protocols hard or impossible to handle
with existing grammar languages and the size of the grammar and its associated transform functions
measured in lines of code.

\begin{tabular}{l|l|l}
\textbf{Protocol} & \textbf{LOC} & \textbf{Problematic features} \\ \hline
DNS messages &  48+64 & Label compression\\
& & Count fields \\
ZIP archives & 92 + 78 & Checksums, \\ 
& & compression, offsets, \\
...
DNS server & 183 + 48 + 64 & 683 (Hammer parser)\\
&&  ~10.000 (DJBDNS)\\ 
DNS \texttt{host} tool & 98 + 48 + 64  & \XXX[TODO]\\
\texttt{unzip} & 50 + 92 + 78 & 1600 (Info-Zip) \\
...
\XXX[Add fuzzing results - no crashes]
