...
archive, thereby undermining Android's security model.}~\cite{saurik-masterkey}\XXX{Duplicate, we
already mention this in the eval} code signing and even the X.509 protocol
