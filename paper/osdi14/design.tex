...
We present both a systematic overview of Nail's syntax with short examples in
Figure~\ref{fig:syntax} shows the elements of Nail grammars and explain our design in more detail
below, using a grammar for the well-known DNS protocol as a guiding example. 
...
\cc{many} already introduces indirection in the data type.
For example example,   arithmetic expressions consisting of sums and products can be parsed as follows:
...
\end{verbatim} \cc{paren = < uint8="("; optional *paren; uint8=")" >}.
