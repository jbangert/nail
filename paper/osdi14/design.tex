...
\item Eliminating redundancy in internal representations, such as
      ...
      to avoid bugs such as in the Python ZIP library.
...
For example, Figure~\ref{fig:dns-full} shows an example grammar for DNS packets and the
corresponding data type and functions that Nail produces.
